  ...
  return (
    <Card className={styles.card}>
      <Card.Body>
        ...
        <Card.Text>
          <p>
            Interessierst du dich für Informatik? Die Infoveranstaltung von Neuland Ingolstadt e.V. findet am <strong>Di, 10.10. um 18:00 in Raum J102</strong> statt. Komm vorbei!
          </p>
        </Card.Text>
      </Card.Body>
    </Card>
