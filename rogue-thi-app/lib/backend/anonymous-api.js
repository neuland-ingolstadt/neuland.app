...
export const ENDPOINT_MODE = process.env.NEXT_PUBLIC_THI_API_MODE || 'websocket-proxy'
const API_KEY = process.env.NEXT_PUBLIC_THI_API_KEY
export const ENDPOINT_HOST = process.env.NEXT_PUBLIC_THI_API_HOST
const ENDPOINT_URL = '/webservice/zits_s_40_test/index.php'
export const PROXY_URL = process.env.NEXT_PUBLIC_PROXY_URL
export const GIT_URL = process.env.NEXT_PUBLIC_GIT_URL
export const USER_AGENT = `neuland.app/${packageInfo.version} (+${GIT_URL})`
